...
left_image = cv.imread('/home/cse-lab-207/Downloads/volume/venv/l.jpg', cv.IMREAD_GRAYSCALE)
right_image = cv.imread('/home/cse-lab-207/Downloads/volume/venv/r.jpg', cv.IMREAD_GRAYSCALE)
...
stereo = cv.StereoBM_create(numDisparities=0, blockSize=7)
